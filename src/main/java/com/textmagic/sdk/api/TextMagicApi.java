...
public class TextMagicApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call importContactsCall(ImportContactsInputObject importContactsInputObject, File file, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call importContactsValidateBeforeCall(ImportContactsInputObject importContactsInputObject, File file, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = importContactsCall(importContactsInputObject, file, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void importContacts(ImportContactsInputObject importContactsInputObject, File file) throws ApiException {
        importContactsWithHttpInfo(importContactsInputObject, file);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> importContactsWithHttpInfo(ImportContactsInputObject importContactsInputObject, File file) throws ApiException {
        com.squareup.okhttp.Call call = importContactsValidateBeforeCall(importContactsInputObject, file, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call importContactsAsync(ImportContactsInputObject importContactsInputObject, File file, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = importContactsValidateBeforeCall(importContactsInputObject, file, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
