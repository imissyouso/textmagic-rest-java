...
/**
 * API tests for OutboundMessageSessionsApi
 */
@Ignore
public class OutboundMessageSessionsApiTest {

    private final OutboundMessageSessionsApi api = new OutboundMessageSessionsApi();
